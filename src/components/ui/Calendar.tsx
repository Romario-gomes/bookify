...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      classNames={{
        months: 'relative flex flex-wrap justify-center align-center gap-9 px-3',
        month_caption:
        ...
        weekday: 'size-10 flex items-center justify-center text-gray-500',
        day: 'inline-flex items-center justify-center rounded text-gray-700 hover:bg-gray-200 hover:text-gray-900 size-8 font-normal aria-selected:opacity-100 cursor-pointer',
